...
local config = {
    ...
    cmd = {
        ...
        '-javaagent:/usr/Applications/lombok/lombok.jar', --
        '-jar',
        '/usr/Applications/jdtls-language-server-latest/plugins/org.eclipse.equinox.launcher_1.6.400.v20210924-0641.jar',
        -- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^                                       ^^^^^^^^^^^^^^
        ...
        -- 💀
        '-configuration',
        '/usr/Applications/jdtls-language-server-latest/config_linux',
        -- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^        ^^^^^^
