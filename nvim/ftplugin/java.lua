...
local config = {
    ...
    cmd = {
        ...
        "-jar",
        "/home/felipe/Documents/executables/jdt-language-server-1.35.0/plugins/org.eclipse.equinox.launcher_1.6.800.v20240330-1250.jar",
        -- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^                                       ^^^^^^^^^^^^^^
        ...
        -- 💀
        "-configuration",
        "/home/felipe/Documents/executables/jdt-language-server-1.35.0/config_linux",
        -- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^        ^^^^^^
