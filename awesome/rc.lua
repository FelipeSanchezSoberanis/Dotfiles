...
beautiful.init("/home/felipe/.config/awesome/themes/custom/theme.lua")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox:setup{
        ...
        { -- Right widgets
            ...
            volume_widget(),
            brightness_widget({program = "brightnessctl", step = 2, type = "icon_and_text"}),
            cpu_widget(),
            ram_widget(),
            battery_widget({show_current_level = true, display_notification = true}),
            mytextclock
            -- s.mylayoutbox,
        }
    }
...
awful.key({modkey}, "d", function() awful.spawn("xrandr-set") end,
          {description = "Set display configuration via xrandr", group = "productivity"}),
...
awful.key({}, "#171", function() awful.spawn("playerctl next") end,
          {description = "Nerxt song", group = "media"}),
awful.key({}, "#118", function() awful.spawn("flameshot gui") end,
...
awful.key({modkey}, "b", function() os.execute("lock-screen") end,
...
awful.key({modkey}, "space", function() os.execute("rotate-keyboard-layout") end,
...
awful.key({modkey}, "r", function()
    awful.spawn("rofi -show run -theme ~/.config/rofi/launchers/type-4/style-1.rasi")
...
awful.key({modkey}, "p", function()
    awful.spawn("rofi -show drun -theme ~/.config/rofi/launchers/type-4/style-3.rasi")
