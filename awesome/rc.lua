...
-- {{{ Key bindings
globalkeys = gears.table.join(awful.key({modkey}, "z", function()
    awful.spawn("zathura-open")
end, {description = "Open pdf in zathura", group = "productivity"}),
                              awful.key({modkey}, "d", function()
    awful.spawn("xrandr-set")
end, {
    description = "Set display configuration via xrandr",
    group = "productivity"
...
end, {description = "Nerxt song", group = "media"}),
                              awful.key({}, "#118", function()
    awful.spawn("flameshot gui")
end, {description = "Take screenshot", group = "media"}),
                              awful.key({}, "#121",
...
awful.key({modkey}, "Return", function() awful.spawn(terminal) end,
    ...
    os.execute("rotate-keyboard-layout")
...
awful.key({modkey}, "r", function()
    awful.spawn(
        "rofi -show run -theme ~/.config/rofi/launchers/type-4/style-1.rasi")
...
awful.key({modkey}, "p", function()
    awful.spawn(
        "rofi -show drun -theme ~/.config/rofi/launchers/type-4/style-3.rasi")
